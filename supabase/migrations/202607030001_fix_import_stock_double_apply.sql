-- Fix double stock application during import:
-- Previously stock_quantity was set directly AND an adjustment transaction was inserted,
-- but apply_stock_transaction trigger also adds adjustment quantity to stock_quantity.
...
is 'Atomic bulk import apply: inserts NEW items at stock 0, writes stock_transactions for deltas, and lets triggers update stock.';
